...
RSpec.describe 'Test the Main Index page', type: :feature do
    describe 'GET the index page' do
        ...
        before(:each) do
            @first_user = User.create(name: 'Victor', photo: 'https://ibedc.com/filesupload/imagebuild/625350ecda1e22.55685312.jpg', bio: 'Teacher', post_counter: 14)
            @first_user.save!
            @another_user = User.create(name: 'John', photo: 'https://ibedc.com/filesupload/imagebuild/625350c770c886.68494374.jpg', bio: 'Developer', post_counter: 2)
            @another_user.save!

            visit root_path

            @first_user_post = Post.create(title: 'My First Post', text: 'Victor First Post', comments_count: 0, likes_count: 3,
                author:  @first_user)
            @second_user_post = Post.create(title: 'My Second Post', text: 'John Second Post', comments_count: 0, likes_count: 0,
                author: @another_user)
